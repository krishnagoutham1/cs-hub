...
<div className="relative px-[5%] py-8">
  ...
  <div className="relative">
    ...
    <div className="flex justify-around flex-wrap">
      {cardData.map((item, i) => {
        return (
          <div className="text-center w-96 gap-5 my-5 bg-gray-50" key={i}>
            <div className={`flex justify-center ${item.bg} py-2 text-7xl`}>
              {item.icon}
            </div>
            <div className="bg-[rgba(244,244,244,0.3)] px-5 text-[#072F53]">
    ...
    {/* <div className="flex items-center relative">
      <div className="w-1/3 absolute z-1">
        <img src={PeopleGroup} className="w-130 rounded-2xl" />
      </div>
      <div className="w-2/3 z-2 bg-white relative rounded-2xl  left-[28%] p-5">
